...
def configure_page():
    st.set_page_config(page_title="ZONAS ACE", layout="wide")
    st.markdown("<h1 style='text-align: center; color: black;'>DISTRIBUCIÓN DE LA PRODUCCIÓN DE LOS YACIMIENTOS EN ACE</h1>", 
